            ...
            <div class="container">
                ...
                <?php
                    ...
                    if(isset($_POST['submit'])){
                        ...
                        $rentprice = null;
                        $rentavail = null;
                        $result = mysqli_query($conn, "SELECT CarID FROM tbcar WHERE CarID = '$carid'");
                        $row = mysqli_fetch_array($result);
                        if ($row > 0){
                            $idvalid = true;
                            $car_sql = "SELECT CarID, CarName, CarPlat, Price, RentStat FROM tbcar WHERE CarID = '$carid'";
                            ...
                            if ($rentavail == 'AVAILABLE'){
                                ...
                                echo '<script>';
                                echo 'alert("Car is not available!")';
                                echo '</script>';
                            }
                        }
                        else{
                            echo '<script>';
                            echo 'alert("Car ID not founded!")';
                            echo '</script>';
                        }
                        ...
                        if(!empty($name) && !empty($gender) && !empty($bdate) && !empty($address) && !empty($phone) && !empty($carid) && !empty($rentdate) && !empty($returndate) && $idvalid && $rentvalid && $avail){
                            ...
                            $order_sql = "INSERT INTO tborder VALUES (NULL, '$name','$phone','$carid','$carname','$carplat','$rentdate','$returndate','$rentprice')";
                            $car_sql = "UPDATE tbcar SET RentStat = 'NOT AVAILABLE' WHERE CarID = '$carid'";
                            if ($nodupephone){
